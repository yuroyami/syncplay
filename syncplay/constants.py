...
PLAYLIST_AUTO_REMOVE_WATCHED_RECHECK_INTERVAL = 3.0
PLAYLIST_AUTO_REMOVE_WATCHED_TIMEOUT = 30.0
PLAYLIST_NEAR_EOF_WINDOW = 270  # seconds
WATCHED_NEAR_EOF_MINIMUM_TIME = 120  # seconds
WATCHED_NEAR_EOF_MINIMUM_PLAYED_TIME = 5  # seconds
...
AUTO_REMOVE_WATCHED_FROM_PLAYLIST = False
DEBUG_MODE = False
...
# JSON watched index feature
WATCHED_HISTORY_ENABLED = False
WATCHED_HISTORY_FILENAME_DEFAULT = ".syncplay-watched.json"
WATCHED_HISTORY_FILENAME = WATCHED_HISTORY_FILENAME_DEFAULT
